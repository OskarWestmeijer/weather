...
public class WeatherImportJobTest {
  ...
  public void shouldImportWeather() {
    ...
    given(openWeatherApiClient.importLatestWeather(importLocation)).willReturn(updatedLocation);
    ...
    then(openWeatherApiClient).should().importLatestWeather(importLocation);
  ...
  public void throwsOnApiRequestException() {
    ...
    given(locationService.getNextImportLocation()).willReturn(importLocation);
    given(openWeatherApiClient.importLatestWeather(importLocation)).willThrow(OpenWeatherApiRequestException.class);
